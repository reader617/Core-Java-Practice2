...
public class Test {
	...
	public static void main(String[] args) 
	{
		...
		/*Invoice i1 = new Invoice("8F32D", "Nails", 100, 0.30);
		Invoice i2 = new Invoice("6G22S", "Hammer", 1, 5.00);
		
		System.out.println("General information item 1");
		System.out.println(i1);
		System.out.println("General information item 2");
		System.out.println(i2);
		
		System.out.println("Testing Setters and getters");
		i1.setPrice(1.0);
		System.out.println("Item 1 Price " + i1.getPrice());
		i2.setQuantity(-50);
		System.out.println("Item 2 Quantity " + i2.getQuantity());*/
		
		// Testing for exercise #2
		/*Employee e1 = new Employee("Jesper", "Fahey", 50000.00);
		Employee e2 = new Employee("Wylan", "Hendricks", 55000.00);
		...
		/*Date today = new Date(6, 28, 2021);
		Date birthday = new Date(0, 0, 0000);
		...
		/*Dog d1 = new Dog("Fido", 5, 50.0);
		Dog d2 = new Dog("Ada", 2, 40.0);
		
		System.out.println("Dog 1: " + d1);
		System.out.println("Dog 2: " + d2);
		
		d1.showExcitement();
		d2.showExcitement(1000);
